...
fact_checks = pd.read_csv("/kaggle/input/semeval2025-task7/fact_checks.csv")
posts = pd.read_csv("/kaggle/input/semeval2025-task7/posts.csv")
pairs = pd.read_csv("/kaggle/input/semeval2025-task7/trial_pairs.csv")
